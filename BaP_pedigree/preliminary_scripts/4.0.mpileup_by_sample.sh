...
screen -d -m -S "$sampleName"."$id".mpileup bash -c "/utils/appz/samtools/samtools-1.2/samtools mpileup -g -t DP -f $mm10min -b bamFiles.$sampleName.$dateTag.txt -r $id > $sampleName.$id.bcf"
